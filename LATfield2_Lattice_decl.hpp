...
public:
    ...
    /*!
     Function which return the size of the vectors
     \return long. Number of array elements contained in 1 vector.
     */
    long  vectorSize();       //Number of sites jumped to move in direction
...
private:
    ...
    long vectorSize_; //size of the vectors
